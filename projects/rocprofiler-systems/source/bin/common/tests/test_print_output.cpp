...
{
    const std::vector<std::string> command_args = { "./myapp" };
...
{
    const std::vector<std::string> env = { "ROCPROFSYS_TEST=value1", "OTHER_VAR=value2" };
    const std::unordered_set<std::string_view> updated = { "ROCPROFSYS_TEST" };
...
{
    const std::vector<std::string>             env     = { "ROCPROFSYS_VAR=test" };
    const std::unordered_set<std::string_view> updated = { "ROCPROFSYS_VAR" };
...
{
    const std::vector<std::string>             env = { "ROCPROFSYS_Z=3", "ROCPROFSYS_A=1",
                                                       "ROCPROFSYS_M=2" };
    const std::unordered_set<std::string_view> updated = { "ROCPROFSYS_Z", "ROCPROFSYS_A",
                                                           "ROCPROFSYS_M" };
...
TEST_F(PrintOutputTest, PrintEnvironment_EmptyEnv)
{
    ...
    const std::unordered_set<std::string_view> updated = {};
...
{
    const std::vector<std::string>             env     = { "ROCPROFSYS_UPDATED=1",
                                                           "ROCPROFSYS_GENERAL=2" };
...
{
    const std::vector<std::string> env = { "OTHER_VAR=value", "PATH=/usr/bin" };
    const std::unordered_set<std::string_view> updated = {};
