...
enum hip_api_id_t {
  ...
  HIP_API_ID_RESERVED_486 = 486,
  HIP_API_ID_hipInitDevice = 487,
  HIP_API_ID_LAST = 487,
...
// hipGetDevicePropertiesR0000[('hipDeviceProp_tR0000*', 'prop'), ('int', 'deviceId')]
#define INIT_hipGetDevicePropertiesR0000_CB_ARGS_DATA(cb_data) { \
  ...
  cb_data.args.hipGetDevicePropertiesR0000.deviceId = (int)device; \
};
...
static inline const char* hipApiString(hip_api_id_t id, const hip_api_data_t* data) {
  ...
  switch (id) {
    ...
    case HIP_API_ID_hipGetDevicePropertiesR0000:
      ...
      oss << ", deviceId="; roctracer::hip_support::detail::operator<<(oss, data->args.hipGetDevicePropertiesR0000.deviceId);
      oss << ")";
    break;
    case HIP_API_ID_hipGetDevicePropertiesR0600:
